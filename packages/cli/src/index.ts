...
/**
 * @minions-proposals/cli — CLI for Minions proposals
 */
...
import { customTypes } from '@minions-proposals/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions proposals'));
        console.log(chalk.dim('Proposal drafts, answer sets, scoring, and prompt version references'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-proposals/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-proposals/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions_proposals')}`);
