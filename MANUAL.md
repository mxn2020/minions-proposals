# Manual Setup Steps for Minions Proposals
...
Go to **GitHub → mxn2020/minions-proposals → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-proposals` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-proposals-web`
- **GitHub repo**: `mxn2020/minions-proposals`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `proposals.minions.wtf`

### Documentation
- **Netlify site name**: `minions-proposals-docs`
- **GitHub repo**: `mxn2020/minions-proposals`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `proposals.minions.help`

### Blog
- **Netlify site name**: `minions-proposals-blog`
- **GitHub repo**: `mxn2020/minions-proposals`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `proposals.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `proposals.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `proposals.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `proposals.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-proposals/sdk`](https://www.npmjs.com/package/@minions-proposals/sdk)
- CLI: [`@minions-proposals/cli`](https://www.npmjs.com/package/@minions-proposals/cli)
...
Your package: [`minions-proposals`](https://pypi.org/project/minions-proposals/)
...
| Item | Value |
|------|-------|
| Project | `minions-proposals` |
| SDK (npm) | `@minions-proposals/sdk` |
| CLI (npm) | `@minions-proposals/cli` |
| Python (PyPI) | `minions-proposals` |
| GitHub | `github.com/mxn2020/minions-proposals` |
| Docs domain | `proposals.minions.help` |
| Blog domain | `proposals.minions.blog` |
| App domain | `proposals.minions.wtf` |
