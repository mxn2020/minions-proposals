...
- `@minions-proposals/sdk` (npm package)
- `minions-proposals` (PyPI package)
- `@minions-proposals/cli` (npm package)
- The minions-proposals web playground
- The minions-proposals documentation site
